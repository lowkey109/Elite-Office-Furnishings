...
const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    solution: "Complete fitout in the Aimu Series — dark walnut executive desks for all partners, Aimu boardroom table for 16, full ergonomic task chair rollout, reception station, and custom breakout zone. Full project management from concept to installation.",
  ...
  },
  {
    ...
    solution: "Full executive floor transformation: custom Aimu executive desks with integrated credenzas, premium leather executive chairs, glass-fronted conference room with Aimu boardroom table for 12, and a dedicated client meeting lounge with premium soft seating.",
  ...
  },
  {
    ...
    solution: "Full activity-based workspace in the Breeze Series: open-plan 80-station workstation run, 6 acoustic meeting pods, 3 breakout café zones, standing desks for all staff, quiet focus booths, and a branded reception zone with feature wall.",
  ...
  },
  {
    ...
    solution: "Coordinated three-site rollout of Breeze Series reception desks, waiting area soft seating, administration workstations, and consultation room furniture. Dedicated project coordinator, staged delivery schedule, and full installation team across all sites.",
  ...
  },
  {
    ...
    solution: "Bespoke fitout combining Aimu executive offices for senior management, a custom boardroom and client presentation suite, and a dedicated property sales suite with premium display configurations, lounge seating, and a custom reception desk.",
  ...
  },
  {
    ...
    solution: "Comprehensive refurbishment: 90 height-adjustable workstations, ergonomic task chairs for all staff, 4 new meeting room configurations, updated breakout areas, and new storage solutions — all selected to comply with government procurement and AS/NZS standards.",
