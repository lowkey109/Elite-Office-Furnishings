...
const PRODUCT_MAP: Record<string, { sku: string; name: string; series: string; category: string; image: string; desc: string }> = {
  workspace: { sku: "LY-WS-01", name: "Axis Workstation", series: "Axis Series", category: "Workstations", image: "/images/category-fitout.png", desc: "Height-adjustable workstation, white top with black powder-coat frame. 160×80cm per position." },
  executive: { sku: "LY-AM-01", name: "Aimu Executive Desk", series: "Aimu Series", category: "Executive Desks", image: "/images/category-desks.png", desc: "Premium veneer executive desk with integrated cable spine and coordinating credenza. Command your space." },
  meeting: { sku: "LY-MT-02", name: "Meridian Meeting Table", series: "Meridian Series", category: "Boardroom Tables", image: "/images/category-boardroom.png", desc: "Rectangular meeting table with 10mm tempered glass top protection. 240×120cm." },
  boardroom: { sku: "LY-BT-01", name: "Summit Boardroom Table", series: "Summit Series", category: "Boardroom Tables", image: "/images/category-boardroom.png", desc: "Premium boardroom table for 12–14 persons. Powered data access, timber veneer top." },
  lounge: { sku: "LY-LS-01", name: "Forma Lounge Sofa", series: "Forma Series", category: "Soft Seating", image: "/images/category-seating.png", desc: "Commercial-grade modular soft seating with timber base and premium woven fabric upholstery." },
  reception: { sku: "LY-RC-01", name: "Arc Reception Counter", series: "Arc Series", category: "Reception Areas", image: "/images/category-reception.png", desc: "Curved reception counter with illuminated acrylic panel and visitor management integration." },
  storage: { sku: "LY-ST-01", name: "Matrix Storage System", series: "Matrix Series", category: "Storage", image: "/images/category-fitout.png", desc: "Modular storage with lockable below-desk and above-desk units. Powder-coat finish." },
  focus: { sku: "LY-FZ-01", name: "Focus Pod Workstation", series: "Focus Series", category: "Workstations", image: "/images/category-fitout.png", desc: "Acoustic-optimised individual focus workstation with privacy screens and task lighting." },
};
