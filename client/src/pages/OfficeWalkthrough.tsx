...
const PRODUCT_MAP: Record<string, { sku: string; name: string; series: string; category: string; image: string; desc: string }> = {
  ...
  meeting: { sku: "FSZ-RUG-TBL-2412", name: "Presidia Conference Table", series: "Presidia", category: "Boardroom Tables", image: "/images/category-boardroom.png", desc: "Premium veneer meeting table for 8–10 persons. Integrated cable management, coordinating credenza available." },
  ...
  reception: { sku: "FSZ-WY-REC-01", name: "Presidia Reception Counter", series: "Presidia", category: "Reception Desks", image: "/images/category-reception.png", desc: "Statement reception counter with premium veneer finish. Integrated modesty panel and storage. Creates a powerful first impression." },
