...
const PRODUCT_MAP: Record<string, { sku: string; name: string; series: string; category: string; image: string; desc: string }> = {
  workspace: { sku: "HSG-MIL-1612-E", name: "Huasheng Milan 1612 Sit-Stand Desk", series: "Milan", category: "Workstations", image: "/images/category-fitout.png", desc: "Electric height-adjustable workstation, 1600×800mm. Dual-motor, anti-collision, memory presets. SGS/BIFMA certified." },
  executive: { sku: "GJO-HX-HXM-A3625", name: "GOJO HXM Executive Desk — Type A 3600", series: "HXM (泓熙)", category: "Executive Desks", image: "/images/category-desks.png", desc: "Grand 3600mm L-shape executive desk. Imported Zingana ebony/African zebrawood, pure copper hardware, gold metal accent rails, mortise-and-tenon joinery. 泓熙 Flowing Brilliance collection." },
  meeting: { sku: "FSZ-RUG-TBL-2412", name: "Feisenzhuo Ruige Conference Table", series: "Ruige", category: "Boardroom Tables", image: "/images/category-boardroom.png", desc: "Premium veneer meeting table for 8–10 persons. Integrated cable management, coordinating credenza available." },
  boardroom: { sku: "GJO-LRU-CON6016", name: "GOJO LRU Conference Table — 6000mm", series: "LRU", category: "Boardroom Tables", image: "/images/category-boardroom.png", desc: "6000×1600mm grand boardroom table. Seats 16–20. Dark oak veneer, geometric metallic base. Matching LRU executive suite." },
  lounge: { sku: "GJO-HX-HXS-A2380", name: "GOJO HXM Three-Person Sofa", series: "HXM (泓熙)", category: "Lounge Seating", image: "/images/category-seating.png", desc: "3-seater executive lounge sofa. Imported Zingana frame with gold metal rails. Premium cream upholstery. Part of HXM Flowing Brilliance collection." },
  reception: { sku: "FSZ-WY-REC-01", name: "Feisenzhuo Weiyi Reception Counter", series: "Weiyi", category: "Reception Desks", image: "/images/category-reception.png", desc: "Statement reception counter with premium veneer finish. Integrated modesty panel and storage. Creates a powerful first impression." },
  storage: { sku: "GJO-YS-LF-4", name: "Yashang 4-Drawer Lateral File Cabinet", series: "Yashang Steel", category: "Storage & Filing", image: "/images/category-fitout.png", desc: "Full-height 4-drawer lateral filing cabinet. Cold-rolled steel, powder-coated white with orange handle. 900×450×1435mm. 83kg. ISO certified." },
  focus: { sku: "HSG-CAPE-CPF02", name: "Huasheng Cape CPF-02 Sit-Stand Desk", series: "Cape", category: "Workstations", image: "/images/category-fitout.png", desc: "Premium electric sit-stand executive desk. Height range 620–1250mm, triple memory preset, anti-collision, whisper-quiet dual motor." },
};
